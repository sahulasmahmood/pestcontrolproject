  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-gray-50 to-white relative">
      ...
      <div className="container mx-auto px-2 sm:px-4 md:px-6 relative">
        ...
        {/* Testimonials container - Better approach for few testimonials */}
        <div className="relative w-full">
          {/* Show navigation arrows only if more than 3 testimonials */}
          ...
          {activeTestimonials.length <= 3 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 max-w-6xl mx-auto px-2 sm:px-3 md:px-4">
              {activeTestimonials.map((testimonial, index) => (
                ...
                >
                  <Card className="hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg h-full bg-white rounded-xl">
